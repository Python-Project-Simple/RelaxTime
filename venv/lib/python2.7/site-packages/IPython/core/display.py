...
class Image(DisplayObject):
    ...
    def __init__(self, data=None, url=None, filename=None, format=None,
        ...
        embed : bool
            ...
            loaded using an <images> tag. Set this to True if you want the image
        ...
        # it only generates `<images>` tag with a link to the source.
    ...
    def _repr_html_(self):
        if not self.embed:
            ...
            return u'<images src="{url}"{width}{height}{klass}/>'.format(
                url=self.url,
                width=width,
                height=height,
                klass=klass,
